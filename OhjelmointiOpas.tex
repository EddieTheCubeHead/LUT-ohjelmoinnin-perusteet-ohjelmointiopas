...
\code{week3}{BasicSwitch}{Valikkorakenne, \java{switch}- ja \java{case} -avainsanojen käyttö
Javassa}
...
\code{week3}{BasicCasting}{Tyyppimuunnos primitiivisestä tietotyypistä toiseen Javassa}
...
\code{week3}{BasicFinal}{\java{final}-avainsanan käyttö Javassa}
...
\code{week3}{CompassPoint}{Lueteltu tyyppi ilmansuunnista}
\code{week3}{BasicEnum}{Lueteltuun tyyppiin viittaaminen}
...
\code{addressbookexample}{ContactManager}{Osoitekirjamanageri osoitekirjan hallintaan}
\code{addressbookexample}{AddressBook}{Pääluokka, joka vastaa ohjelman ajamisesta}
...
\code{week6}{BasicInheritanceParent}{Periytymisesimerkin kantaluokka}
\code{week6}{BasicInheritanceChild}{Periytymisesimerkin lapsiluokka}
\code{week6}{BasicInheritanceMain}{Periytymisesimerkin pääluokka}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section{Lisää periytymisen teoriaa}
\label{periytyminen4}
...
\newthought{Serialisaatio on} mahdollista vain
