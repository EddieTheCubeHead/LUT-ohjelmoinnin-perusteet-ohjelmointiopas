...
Seuraava taulukko esittelee Javan perusoperaatiot.
...
pieni kuin b \\
\& & bittikohtainen JA & a \& b & Vertaa a:n ja b:n bittirepresentaatiota ja palauttaa
binäärinumeron,\newline{} jossa on 1 kohdissa, joissa sekä a:ssa että b:ssä on 1, muualla 0 \\
\bottomrule
\end{tabular}
\end{center}
