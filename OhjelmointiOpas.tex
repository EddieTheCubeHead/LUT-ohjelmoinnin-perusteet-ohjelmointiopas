...
\newthought{Opas on jaettu} yhteentoista sisältölukuu. Luvut käsittelevät kurssilla käsiteltäviä
sisältöjä ja sisältävät kaiken kurssin sisältöön kuuluvan materiaalin. Luvut on numeroitu välillä
0-11 niin, että luvun numero vastaa viikkoa, jolla luvun sisältöä käsitellään kurssilla ja luku 0
käsittelee itse opasta ja sen käyttöä. Näin opasta on helppo seurata kurssin edetessä. Viikolla
7 käsitellään vain Androidin API:a, joten oppaassa ei ole lukua 7. Android API:n käsittely on
jätetty oppaasta pois, koska API muuttuu ja kehittyy niin nopeasti, että sitä käsittelevät osat
todennäköisesti vanhenisivat vuodessa tai kahdessa.
...
\code{week10/genericexample}{Main}{Säiliöluokan instanssin luominen, ja vaihtometodin kutsuminen}
...
\code{week10/genericinheritance}{Main}{Parametrisoidun ja geneerisen validaattoriluokan luonti	
koodissa}
...
\code{week10/iteratorexample}{Main}{Merkkijonolistan iteraattorin luominen, ensimmäisen alkion
kuluttaminen ja loppujen tulostaminen luodulla tulostinluokalla}
...
\code{week11/innerclassexample}{Main}{Sisäluokan instanssin luominen ja käyttö}
...
\code{week11/anonymousclassexample}{Main}{Anonyymin luokan luominen ja käyttö}
...
\newthought{Mikäli halutaan} luoda aidosti uusi kopio "MyObject"-instanssista tarvitaan Javassa
