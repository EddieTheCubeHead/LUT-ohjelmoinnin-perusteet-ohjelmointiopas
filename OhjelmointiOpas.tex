...
ohjelmalle mahdollisuuden viitata luokan ilmentymää, jolle jokin metodi kuuluu. This toimii
vain rakentajassa ja ilmentymään sidotuissa metodeissa, eli konteksteissa, joissa ilmentymä, johon
viitataan on tiedossa. Täten rakentajassa voidaan yhdistämällä this-avainsana ja pistenotaatio
viitata helposti rakennettavaan ilmentymään.
...
asetettavan muuttujan tyyppiä olevan ilmentymän eikä palauta mitään. Samoin kuin noutajat,
...
ja käsitellään myöhemmin osiossa \nameref{for each}. For-avainsanan jälkeen for-loopissa seuraa
...
AdressBookManager-luokan ilmentymä ja jonka main-metodi pyörittää ikuista looppia. Tämä 
manager-ilmentymä sisältää metodeja, jota pääluokasta voidaan kutsua käyttäjän valinnan mukaan.
...
ilmentymän uuteen muuttujaan tämä ei kopioi ilmentymän arvoja. Sen sijaan tällainen tallennus luo
uuden viittauksen samaan "MyObject"-ilmentymään. Jos tämän uuden muuttujan tilaa muokataan, myös
...
on jonkin luokan ilmentymä ja suorittaa arvokopion vain jos muuttujan tyyppi on primitiivinen
tietotyyppi. Näin kopiointi on melko nopea toimenpide ja uusi ja alkuperäinen ilmentymä eivät ole
suoraan riippuvaisia toisistaan. Kuitenkin luodun uuden ilmentymän ei-primitiivisen tietotyypin
muuttujat viittavaat samoihin olioihin kuin alkuperäisen ilmentymän vastaavat muuttujat. Täten
