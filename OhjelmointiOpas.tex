...
\code{week2}{BasicArrayDataPoint}{Dataluokka käytettäväksi taulukkoesimerkissä}
\code{week2}{BasicArray}{Taulukkojen käyttö Javassa}
...
ja monikäyttöisin on \newjava{ArrayList}. Se muistuttaa pythonin listaa
