...
\usepackage[nomarginpar,margin=.8in]{geometry}
\usepackage{hyperref}
...
\titleformat{\chapter}[hang]{\Huge\rmfamily\scshape}{\thechapter}{18pt}{\Huge\rmfamily\scshape}
\titleformat{\section}[hang]{\huge\rmfamily}{\thesection}{12pt}{\huge\rmfamily}
\titleformat{\subsection}[hang]{\Large\bfseries}{\thesubsection}{9pt}{\Large\bfseries}
...
\hypersetup{colorlinks,pdfborder={0 0 0},bookmarksdepth=section,citecolor=green,linkcolor=blue,urlcolor=green}
...
%%
% Book metadata
\title{Ohjelmointiopas \\ \small{\lutin olio-ohjelmointikurssi} \\ \small{versio Beta 0.3.0}}
...
\SetupFloatingEnvironment{table}{name=Taulukko}
...
\renewcommand{\listtablename}{Oppaan taulukot}
...
\textsc{Tämä on oppaan betaversio}
...
(\nameref{overloading}) käsiteltävä ylikuormittaminen toimii myös rakentajametodeihin, eli
...
yhteydessä oppaan osiossa \nameref{casting2}. Koodiesimerkki 
...
kuten kappale \nameref{syötteestä} esittelee. Koodiesimerkki \ref{week4/BasicFileWriterReader}
...
\ref{week11/anonymousclassexample/AnonymousClassesExample} esittelee \nameref{consumers}-kappaleen
