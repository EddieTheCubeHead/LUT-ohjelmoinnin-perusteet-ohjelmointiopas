...
sisällä. Tämän luokan nimi on \neweng{sisaluokka}{inner class}. Sisäluokka näkee kaikki muuttujat
luokasta, jonka sisällä se on määritelty. Lisäksi sisäluokka voidaan normaalin luokan sijaan
määritellä näkyvyysmääreellä \java{protected} tai \java{private}. Tarvittaessa sisäluokka voidaan
m
