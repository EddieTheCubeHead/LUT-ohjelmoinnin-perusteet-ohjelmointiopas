...
new-avainsanalla sulkemalla normaalin geneerisen luokan määritelmän tapaan säilöttävä luokka
pienempi kuin- ja suurempi kuin -merkkien väliin. Tällöin merkkijonoja säilövä ArrayList-instanssi
voidaan luoda seuraavalla koodinpätkällä:\newline{}"new ArrayList<String>();"},
	see={java:List,geneerisyys,java:new}
}
